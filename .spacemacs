...
values."
  (setq-default
   ...
   '((auto-completion :variables auto-completion-enable-help-tooltip t
     ...
     (osx :variables osx-use-option-as-meta t) (git :variables git-use-magit-next t) github javascript emacs-lisp ruby
     version-control colors shell-scripts markdown html clojure)
...
layers configuration. You are free to put any user code."
  ...
  (defun kushana/workspace (port)
    (interactive "sPort number:")
    (let ((cur (current-buffer))
          (kushana-project "~/Git/kushana")
          (cider-prompt-for-project-on-connect nil))
      (cider-connect "localhost" port)
      (cider-assoc-project-with-connection kushana-project "*cider-repl localhost*")
      (cider-connect "localhost" port)
      (cider-assoc-project-with-connection kushana-project "*cider-repl localhost*<2>")
